...
public class TreeViewer implements TreeModel
{
   ...
   * specified document
   */
  public TreeViewer(Document document)
  {
   ...
   */
  public TreeViewer(Element element)
  {
   ...
   */
  public static void main(Document d) throws IOException, SAXException
  {
    Document document = d;
    ...
    JTree tree = new JTree(new TreeViewer(walker));
